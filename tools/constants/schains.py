...
from tools.constants import CONFIG_FOLDER, NODE_DATA_PATH
...
FAIR_BASE_SCHAIN_CONFIG_FILENAME = 'fair_base_config.json'
FAIR_BASE_SCHAIN_CONFIG_FILEPATH = os.path.join(CONFIG_FOLDER, FAIR_BASE_SCHAIN_CONFIG_FILENAME)
...
FAIR_PRECOMPILED_CONTRACTS_FILENAME = 'fair_precompiled_contracts.json'
FAIR_PRECOMPILED_CONTRACTS_FILEPATH = os.path.join(
    CONFIG_FOLDER, FAIR_PRECOMPILED_CONTRACTS_FILENAME
)

SCHAIN_CHECKS_FILENAME = 'checks.json'
