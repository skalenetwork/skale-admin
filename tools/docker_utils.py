...
class DockerUtils:
    ...
    def get_all_skale_containers(self, _all=False, format=False) -> list:
        return self.get_containers_info(_all=_all, name_filter='skale_*')

    def get_all_schain_containers(self, _all=False, format=False) -> list:
        return self.get_containers_info(_all=_all, name_filter='skale_schain_*')
