...
MIRAGE_BASE_SCHAIN_CONFIG_FILENAME = 'mirage_base_config.json'
MIRAGE_BASE_SCHAIN_CONFIG_FILEPATH = os.path.join(CONFIG_FOLDER, MIRAGE_BASE_SCHAIN_CONFIG_FILENAME)
...
MIRAGE_PRECOMPILED_CONTRACTS_FILENAME = 'mirage_precompiled_contracts.json'
MIRAGE_PRECOMPILED_CONTRACTS_FILEPATH = os.path.join(
    CONFIG_FOLDER, MIRAGE_PRECOMPILED_CONTRACTS_FILENAME
)
